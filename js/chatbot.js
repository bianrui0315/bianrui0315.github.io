document.addEventListener('DOMContentLoaded', () => {
    ...
    function getBotResponse(message) {
        ...
        if (lowerCaseMessage.includes('hello') || lowerCaseMessage.includes('hi')) {
            ...
            return "Rui has shipped production AI/data systems and public products, including an adaptive creative analysis API, OpenChat for AI Agents, Free Image Tools, LangGraph pipeline orchestration, student risk prediction, compliance automation, and internet-scale proxy research. Explore the Projects section!";
